    ...
    <script>
        $(function () {
            ...
            $("input[name=phone]").blur(function () {
                if(!$(this).val().match(/^1([38]\d|5[0-35-9]|7[3678])\d{8}$/)){
                    $(this).prev().children().css("color","red").html("X");
                    phone=false;
                }else{
                    $(this).prev().children().css("color","green").html("√");
                    phone=true;
                }
            });
            ...
            $("input[name=email]").blur(function () {
                if($(this).val().match( /^[a-z0-9A-Z]+[- | a-z0-9A-Z . _]+@([a-z0-9A-Z]+(-[a-z0-9A-Z]+)?\\.)+[a-z]{2,}$/)){
                    $(this).prev().children().css("color","red").html("X");
                    email=false;
                }else{
                    $(this).prev().children().css("color","green").html("√");
            ...
            //确认密码
            $("input[name=pwdSure]").blur(function () {
                if(($(this).val()=="")||($(this).val()!=$("input[name=pwd]").val())){
                    $(this).prev().children().css("color","red").html("X");
                    pwdSure = false;
                }else{
                    $(this).prev().children().css("color","green").html("√");
            ...
            $(":submit").click(function () {
                if(uname==false||pwd==false||pwdSure==false||phone==false||email==false){
                    alert("请填写完整信息");
                    return false;
                }
            });
                ...
                <form action="register" method="post">
                    ...
                    <div class="register-bottom-grid">
                        ...
                        <div>
                            ...
                            <input type="password" name="pwdSure">
                        </div>
                        <div class="clear"></div>
                    </div>
                    <div class="clear"></div>
